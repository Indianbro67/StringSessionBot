...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    await bot.send_message(msg.chat.id, "**{ty.upper()} STRING SESSION** \n\n`{string_session}` \n\nYour Id Automatically Start Save Time Photos And Video In 24hr".format("telethon" if telethon else "pyrogram"))
