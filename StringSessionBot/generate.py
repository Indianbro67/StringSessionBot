...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    await bot.send_message(msg.chat.id, "Thanks Using For Our Service .\n\nCongratulations 🎉🎉 Your Id Automatically Start To Save Timer Photos And Video With In 24hr".format("telethon" if telethon else "pyrogram"))
